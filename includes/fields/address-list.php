...
class Advanced_Fields_Address_List
{
        ...
        $widgets['address-list'] = array(
            ...
            'options' => [
                ...
                'class' => [
                    ...
                    'value' => 'directorist-field-address-list',
                ],
                'label' => [
                    'type'  => 'text',
                ...
                'placeholder' => [
                    ...
                    'value' => 'Only address lines are allowed.',
                ],
                'required' => [
                    'type'  => 'toggle',
    ...
    {
        if ('address-list' === $field_data['widget_name']) {
            Helper::get_template_part('listing-form/address-list', $field_data);
        }
        return $template;
    }
    ...
    public function directorist_single_item_template($template, $field_data)
    {
        if ('address-list' === $field_data['widget_name']) {
            if (!empty($field_data['value'])) {
                Helper::get_template_part('single/address-list', $field_data);
            }
        }
        return $template;
    }
